...
public class SbLjsbqkActivity extends Activity {
	// 以下三变量在DataInit中初始化
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pb1 = new ProgressDialog(SbLjsbqkActivity.this);
	...
	private void showTips() {
		AlertDialog alertDialog = new AlertDialog.Builder(SbLjsbqkActivity.this)
