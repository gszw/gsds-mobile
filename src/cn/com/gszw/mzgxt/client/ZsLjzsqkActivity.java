...
public class ZsLjzsqkActivity extends Activity {
	// 以下三变量在DataInit中初始化
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pb1 = new ProgressDialog(ZsLjzsqkActivity.this);
	...
	private void showTips() {
		AlertDialog alertDialog = new AlertDialog.Builder(ZsLjzsqkActivity.this)
